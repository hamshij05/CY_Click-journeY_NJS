...
<body>
	...
	<!--journey highlights is used here to represent all the details for this trip with a list-->
        <section class="journey-highlights" style="background-image: url('../assets/images/kansai-tohoku-culture.jpg') ;">
            <h2>Circuit <em>Kansai - Tohoku</em></h2>
	    <p>Explorez les trésors spirituels de Kyoto et Nara, avant de plonger dans la beauté sauvage de Tohoku. 10 jours d’émerveillement entre temples ancestraux et paysages automnaux. Une aventure unique au cœur du Japon.</p><br/>
	    ...
	    <p> Vous séjournerez pendant 5 jours au luxueux hôtel The Ritz-Carlton à Kyoto, idéalement situé pour visiter tous les sites touristiques.</p>
            ...
            <ul class="highlights-list">
                <li>Jour 1 : Arrive à Tokyo – Prend un Shinkansen pour Kyoto – Dépose les valises à l'hotel – Temple Kiyomizu-dera, promenade à Gion
</li>
                <li>Jour 2 :  Kyoto – Arashiyama (forêt de bambous) et temple Tofuku-ji (feuilles rouges)</li>
                <li>Jour 3 : Nara – Parc de Nara, visite du temple Todai-ji</li>
                <li>Jour 4 : Koyasan – Nuit dans un temple bouddhiste, méditation zen</li>
